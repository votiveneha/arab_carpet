          ...
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <a href="{{route('admin.addModel')}}" class="btn btn-outline-info btn-fw" style="float: right;">Add Model</a>
                    <h4 class="card-title">Model Management</h4>
                    <p class="card-description"> Model List
                    </p>
                    <form id="bulkDeleteForm" method="POST" action="{{ route('admin.bulkDeleteModel') }}">
                      @csrf
                        ...
                        <table class="table table-striped" id="example">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="{{route('admin.addModel')}}/{{ $list->id }}"><i class="mdi mdi-lead-pencil"></i></a></td>
                            </tr>
                            @php $i++; @endphp
                            @endforeach
                            @endif
        ...
        <script>
          ...
          $(document).ready(function () {
            $(document).on('change','.user_status',function(){
              ...
              $.ajax({
                url: "{{url('/admin/updateModelStatus')}}",
                type: "POST",
                datatype: "json",
                data: {
                  status: status,
                ...
                success: function(result) {
                  Swal.fire({
                    title: "Success!",
                    text: "Make Model Status updated!",
                    icon: "success"
                  });
                },
                errror: function(xhr) {
          ...
          document.getElementById('bulkDeleteBtn').addEventListener('click', function (e) {
            ...
            if (checkboxes.length === 0) {
              Swal.fire({
                icon: 'warning',
                title: 'No selection',
                text: 'Please select at least one Make Model to delete.',
              });
              return;
            }
            ...
            Swal.fire({
              title: 'Are you sure?',
              text: "Selected Make Model will be deleted.",
              icon: 'warning',
