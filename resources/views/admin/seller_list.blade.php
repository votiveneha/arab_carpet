        ...
        <div class="content-wrapper">
            <div class="row">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('admin.sellerProfile') }}" class="btn btn-outline-info btn-fw"
                                style="float: right;">Add Seller</a>
                            <h4 class="card-title">Seller Management</h4>
                            <p class="card-description"> Seller List
                            </p>
    ...
    <script>
        $(document).ready(function() {
            let table = $('#example').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('/admin/getAdminSellerList') }}",
                    type: 'POST',
                    data: function (d) {
                        return $.extend({}, d, {
                ...
                columns: [
                    ...
                    { data: 'user_name', name: 'users.first_name' },   // searchable
                    { data: 'business_name', name: 'shop_detail.shop_name' }, // searchable
                    { data: 'phone_number1', name: 'users.mobile' },   // searchable
                    { data: 'city', name: 'master_city.city_name' },   // searchable
                    { data: 'status', name: 'users.user_status' },     // searchable + orderable
...
//console.log(checkboxes);
            if (checkboxes.length === 0) {
                Swal.fire({
                    icon: 'warning',
                    title: 'No selection',
                    text: 'Please select at least one seller to delete.',
                });
                return;
            }
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "Selected seller will be deleted.",
                icon: 'warning',
                showCancelButton: true,
