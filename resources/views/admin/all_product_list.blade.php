  ...
  text-transform: uppercase;
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <a href="{{route('admin.addAdminProduct')}}" class="btn btn-outline-info btn-fw" style="float: right;">Add Admin Product</a>
                    <h4 class="card-title">Admin Product Management</h4>
                    <p class="card-description"> Admin Product List 
                    </p>
                    <form id="bulkDeleteForm" method="POST" action="{{ route('admin.bulkDeleteproduct') }}">
                      @csrf
        ...
        <script>
          ...
          let table = $('#example').DataTable({
              ...
              serverSide: true,
              ajax: {
                  url: "{{url('/admin/getCommonProduct')}}",
