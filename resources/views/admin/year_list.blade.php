          ...
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <a href="{{route('admin.addMakeYear')}}" class="btn btn-outline-info btn-fw" style="float: right;">Add Generation</a>
                    <h4 class="card-title">Generation Management</h4>
                    <p class="card-description"> Generation List 
                    </p>
                        ...
                        <table class="table table-striped" id="example">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td> {{$list->gen_text}} </td>
                              <td>                              
                                 <a href="{{route('admin.addMakeYear')}}/{{ $list->id }}"><i class="mdi mdi-lead-pencil"></i></a> <!--| 
                                <a href="{{route('admin.subGenerationList')}}/{{ $list->id }}"><i class="mdi mdi-format-list-bulleted" title="Make Model List"></i></a> -->
                              </td>
                            </tr>
                            @php $i++; @endphp 
                            @endforeach
