              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Add Part Catalogue </p>
                    <form class="forms-sample" method="post" action="{{route('admin.addPartCatalogue')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                      <div class="row">
                        <div class="form-group col-md-6">
                          <label for="exampleInputEmail1">PART</label>
                          <select required class="form-select form-select-sm select-drop" id="category" name="category_id">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <select required class="form-select form-select-sm select-drop" id="subcategory" name="subcategory_id">
