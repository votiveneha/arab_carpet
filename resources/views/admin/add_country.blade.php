              ...
              <div class="col-md-12 grid-margin stretch-card">
                <?php
                  ...
                  if($country_detail)
                  {
                    ...
                    $currency=$country_detail->currency;
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <input required type="text" class="form-control form-control-sm"
                   placeholder="Enter Country Name" name="country_name" value="{{$country_name}}">
        </div>

        <div class="form-group col-md-6">
            <label for="exampleInputUsername1">Currency Code</label>
            <input required type="text" class="form-control form-control-sm"
                   placeholder="Enter Country Code" name="currency" value="{{$currency}}">
        </div>
    </div>
