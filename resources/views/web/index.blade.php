@extends('web.common.layout') @section('content')
    ...
    <section class="hero-section text-center">
        ...
        <form class="search-bar d-flex flex-wrap justify-content-center gap-2 mt-4" method="get"
            action="{{ route('productList') }}">
            ...
            <div class="access-auto-parts">
                <div class="filter-box">
                    ...
                    <div class="model-add-two-select">
            ...
            <div class="search-btn-add">
                <button class="filter-search-btn" id="searchBtn">{{ __('messages.search') }}</button>
            </div>
