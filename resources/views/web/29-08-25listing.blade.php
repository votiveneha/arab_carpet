    ...
    <div class="breadcrumb">
        <div class="container">
            <ul class="breadcrumb-list" id="breadcrumbList">
                <li>
                    <a href="#">
                        {{ !empty($header['year']) ? $header['year'] : 'ALL YEAR' }}
                        {{ !empty($header['brand']) ? $header['brand'] : 'ALL MAKE' }}
                        {{ !empty($header['model']) ? $header['model'] : 'ALL MODEL' }}
                    </a> &gt;
                </li>
                <li>
                    <a href="#">{{ !empty($header['category']) ? $header['category'] : 'ALL PART TYPE' }}</a> &gt;
                </li>
                <li>
                    <a href="#">{{ !empty($header['subcatagory']) ? $header['subcatagory'] : 'ALL PART' }}</a>
                </li>
            </ul>
            <!-- Scroll Arrow -->
                    ...
                    <div class="product-listing">
                        @if ($products)
                            @foreach ($products as $product)
                                ...
                                <div class="listing-item listing-pg"
                                    onclick="goToMiniPage('{{ route('productDetail', $product->id) }}')"
                                    ...
                                    <div class="new-ven-add">
                                        <div class="vendor-info">
                                            ...
                                            <a
                                                href="{{ route('shopDetail', ['city' => $product->city_name, 'shop' => $product->shop_name_en]) }}">
                                                <div style="color:#000000" class="vendor-name"">{{ $product->shop_name }}
                                                </div>
                                            </a>
                                    ...
                                    '{{ $product->stock_number }}',event)">
                                            ...
                                            <a style="color:#000000 !important" href="tel:{{ $phone }}">
