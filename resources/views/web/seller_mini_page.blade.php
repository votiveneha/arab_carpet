    ...
    {{-- <div class="breadcrumb">
        <div class="container">
            <ul class="breadcrumb-list">
                ...
                <li><a
                        href="{{ route('shopDetail', ['city' => $user->city_name, 'shop' => $shop->shop_name_en]) }}">{{ $shop->shop_name }}</a>
                </li>
            </ul>
            <!-- Scroll Arrow -->
                            ...
                            @if ($city)
                                @foreach ($city as $citys)
                                    <option value="{{ $citys->city_id }}"
                                        {{ request('city_id') == $citys->city_id ? 'selected' : '' }}>
                ...
                <div class="col-md-9 shop-center-detail shop-product-list-right">
                    <div class="product-listing shop-mini-product-add" >
                        <div class="shop-detail-name-add">
                            <a
                                href="{{ route('shopDetail', ['city' => $user->city_name, 'shop' => $shop->shop_name_en]) }}">
                        ...
                        @if ($products)
                            @foreach ($products as $product)
                                <div class="listing-item" onclick="redirectToDetail('{{ route('productDetail', $product->id) }}')" style="cursor:pointer;">
                                    <div class="new-ven-add">
                                        <div class="vendor-info">
                                            <div class="vendor-name">
                                                <a href="{{ route('productDetail', $product->id) }}"
                                                    class="track-product-click_old" data-product-id="{{ $product->id }}"
                                    ...
                                    <div class="contact-options">
                                        <div class="product-price">
                                            @if ($product->product_price > 0)
                                                {{ $product->product_price }}  {{ $user->currency }}
                                            @endif
                                        </div>
                                    ...
                                    <a
                                        ...
                                        <div class="vendor-icons right-side-add-detail">
