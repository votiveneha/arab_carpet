                ...
                <div class="col-md-9 shop-center-detail">
                    <div class="product-card">
                        <div class="inner-price-set">
                            ...
                            <div class="seller-info">
                                ...
                                <div class="icons">
                                  ...
                                  <span>{{--  <i class="bi bi-shop"> --}} </i>{{ $product->shop_name }} <span
                                        class="loc-add-text">{{ $user->city_name }}</span></span>
                            </div>
                        </div>
                        ...
                        <div class="fits" style="border-bottom: 1px solid #eee;">
                            ...
                            <div class=" mt-3 shop-product-list-right" style="border-bottom: 1px solid #eee; height: 165px;">
                                                ...
                                                <div class="vendor-name">
                                                    <a href="{{ route('productDetail', $product->id) }}"
                                                      ...
                                                      <span>{{ $product->subcategory_name }}</span>
                                                       <br> <span class="year">( {{ $product->start_year }} - {{ $product->end_year }}) </span>
                                                    </a>
                                                </div>
