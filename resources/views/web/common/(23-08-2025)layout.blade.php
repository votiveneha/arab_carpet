 ...
 <!-- Language & Login -->
                        <div class="language-login d-flex align-items-center mobile-view-add-lauguage top-add-desktop-btn">
                            <div class="dropdown english-drop me-3">
                                <button class="btn btn-light dropdown-toggle desktop-view-add-convert" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    {{ app()->getLocale()=='en'?'ENGLISH':'عربي' }}
                                </button>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item {{ app()->getLocale() == 'en' ? 'active' : '' }}" href="{{ route('lang.switch', 'en') }}">
                                            ENGLISH @if(app()->getLocale() == 'en') @endif
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item {{ app()->getLocale() == 'ar' ? 'active' : '' }}" href="{{ route('lang.switch', 'ar') }}">
                                            عربي @if(app()->getLocale() == 'ar') @endif
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <!-- Modal -->
                            <!-- Login Modal -->
                            <div id="loginModal" class="modal login-modal-add" style="direction: {{ App::getLocale() === 'ar' ? 'rtl' : 'ltr' }};">
                                <div class="modal-content">
                                  <div class="modal-header login-close-btn-add">
                                            <button type="button" class="btn-close modal-close-all" onclick="closeAllModals()"></button>
                                        </div>
                            ...
                            <div class="modal fade" id="signupModal" tabindex="-1" aria-labelledby="signupModalLabel" aria-hidden="true" data-bs-backdrop="false" style="direction: {{ App::getLocale() === 'ar' ? 'rtl' : 'ltr' }};">
                                            ...
                                            <div class="login-modal">
                                                ...
                                                <form id="signupForm" method="post" action="{{route('web.signup')}}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div style="display: flex;gap: 5px; {{ App::getLocale() === 'ar' ? 'flex-direction:row-reverse;' : '' }}" >
                                                            <select name="country_code" required style="width: 100px;border: none;border-bottom: 1px solid #999;">
                                                                @foreach($country as $countrys)
                                                                    <option value="{{$countrys->phonecode}}">{{$countrys->iso2}} {{$countrys->phonecode}}</option>
                                                                @endforeach
                                                            </select>

                                                            <div style="flex: 1; position: relative;" class="input-icon-wrapper">
                                                                <i class="bi bi-telephone"></i>
                                                                <input type="tel" name="mobile" placeholder="{{ __('messages.mobile_number') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" minlength="4" maxlength="15" required />
                                                            </div>
                                                        </div>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <header class="header w-100">
                        ...
                        <div class="language-login d-flex align-items-center mobile-view-add-lauguage-desktop">
                            ...
                            <!-- Modal -->
                            <!-- Login Modal -->
                            <div id="loginModal" class="modal" style="direction: {{ App::getLocale() === 'ar' ? 'rtl' : 'ltr' }};">
                                <div class="modal-content">
                                  <div class="modal-header login-close-btn-add">
                                            <button type="button" class="btn-close modal-close-all" onclick="closeAllModals()"></button>
                                        </div>
        ...
        <div class="rights-reserved">
            <p>
                ...
                {!! strtr(__('messages.footer3'), [':url' => route('web.getTermsConditions'),':url1' => route('web.getPrivacyPolicy'),]) !!} <br />
                {{ __('messages.footer4') }}
            </p>
            ...
            <p>
                ...
                <span><a class="dropdown-item {{ app()->getLocale() == 'ar' ? 'active' : '' }}" href="{{ route('lang.switch', 'ar') }}">العربية</a> 
                </span>
                  </div>
            </p>
        </div>
