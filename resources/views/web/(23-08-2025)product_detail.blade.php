                    ...
                    <div class="product-card">
                        <div class="inner-price-set">
                            <div class="card-header">
                                <span
                                    class="status not-working">{{ $product->product_type == 1 ? 'EXCELLENT' : ($product->product_type == 2 ? 'GOOD' : 'NOT WORKING') }}</span>
                                <div class="price">
                            ...
                            <div class="seller-info">
                                <span><i class="bi bi-shop"></i>{{ $shop->shop_name }} <span
                                ...
                                <div class="icons">
                                    ...
                                    <button style="border: none;" onclick="openMap('{{ $product->user_lat }}','{{ $product->user_long }}', event)">
