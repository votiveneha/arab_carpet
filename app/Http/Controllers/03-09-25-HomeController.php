...
class HomeController extends Controller
{
    ...
    public function productDetail(Request $request, $id)
    {
        ...
        $descCol = match ($locale) {
            'ar' => 'p.product_description_ar',
            'fr' => 'p.product_description_fr',
            'ru' => 'p.product_description_ru',
            'fa' => 'p.product_description_fa',
            'ur' => 'p.product_description_ur',
            default => 'p.product_description', // fallback English
        };
    ...
    public function shopDetail(Request $request, $city, $shop)
    {
        ...
        $shop  = DB::table('shop_detail')
            ->select(
                ...
                DB::raw(
                    in_array($locale, ['ar', 'fr', 'ru', 'fa', 'ur'])
                        ? "NULLIF(shop_detail.about_shop_{$locale}, '') as about_shop"
    ...
    public function sellerMiniPage(Request $request, $id)
    {
        ...
        // category + subcategory localized if available
        if (in_array($locale, ['ar', 'fr', 'ru', 'fa', 'ur'])) {
            $categoryCol    = "{$locale}_category_name";
            $subcategoryCol = "{$locale}_subcat_name";
        } else {
