...
class SellerDashboardController extends Controller
{
    ...
    public function addProduct(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $product->product_description_fr   = $request->product_description_fr;
            $product->product_description_ru   = $request->product_description_ru;
            $product->product_description_fa   = $request->product_description_fa;
            $product->product_description_ur   = $request->product_description_ur;
        ...
        foreach ($chunks as $chunk) {
            foreach ($chunk as $item) {
                ...
                $product = Product::create([
                    ...
                    // 'product_description_fr'   => $request->product_description_fr,
                    // 'product_description_ru'   => $request->product_description_ru,
                    // 'product_description_fa'   => $request->product_description_fa,
                    // 'product_description_ur'   => $request->product_description_ur,
